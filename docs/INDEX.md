...
> **Audience:** all
> **Status:** current
> **Verified against:** sigmond e1c4452 on 2026-08-23 — code
...
| [scientist/skeleton/README.md](scientist/skeleton/README.md) | The copyable minimal client scaffold (`deploy.toml`, templated unit, `cli.py` with the four contract verbs, `config/help.toml`) — MIT, runs on a laptop with stdlib Python, with the real output of every verb and a list of what is stubbed |
