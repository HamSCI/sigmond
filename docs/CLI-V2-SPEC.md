...
- The five capability gaps from §3 of the inventory (activity
  watches in TUI, sources in TUI, verifier in TUI, identity/refresh
  in TUI, cpu-affinity/freq `--apply` in TUI). v2 cleans up the
  CLI; the TUI gap-fill is a separate track.
